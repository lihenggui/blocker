...
/**
 * Fake implementation of the [GeneralRuleRepository] that retrieves the rules from a fake data set,
 * and uses a local DataStore instance to save and retrieve followed rule ids.
 *
 * This allows us to run the app with fake data, without needing an internet connection or working
 * backend.
 */

internal class FakeGeneralRuleRepository @Inject constructor() : GeneralRuleRepository {

    private val generalRule = listOf(
        GeneralRule(
            id = 1,
    ...
    override fun getGeneralRules(): Flow<List<GeneralRule>> = flowOf(generalRule)
