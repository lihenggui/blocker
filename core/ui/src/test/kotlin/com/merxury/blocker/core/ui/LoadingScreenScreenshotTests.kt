...
class LoadingScreenScreenshotTests {
    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun loadingScreen_multipleThemes() {
        composeTestRule.captureMultiTheme("LoadingScreen") {
            Surface {
    ...
    @Composable
    private fun LoadingScreenExample() {
        LoadingScreen()
    }
}
