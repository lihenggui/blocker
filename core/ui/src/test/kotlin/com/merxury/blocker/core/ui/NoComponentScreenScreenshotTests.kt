...
class NoComponentScreenScreenshotTests {
    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun noComponentScreen_multipleThemes() {
        composeTestRule.captureMultiTheme("NoComponentScreen") {
            Surface {
                NoComponentScreenExample()
            }
        }
    }

    @Test
    fun noComponentScreen_hugeFont() {
    ...
    @Composable
    private fun NoComponentScreenExample() {
        NoComponentScreen()
    }
}
