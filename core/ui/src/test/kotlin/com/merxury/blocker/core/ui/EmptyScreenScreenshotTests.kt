...
class EmptyScreenScreenshotTests {
    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun emptyScreen_multipleThemes() {
        composeTestRule.captureMultiTheme("EmptyScreen") {
            Surface {
                EmptyScreenExample()
            }
        }
    ...
    @Composable
    private fun EmptyScreenExample() {
