...
import com.merxury.blocker.core.designsystem.bottomsheet.getString
...
fun ErrorScreen(error: UiMessage) {
    Column(
        ...
        BlockerDisplayIcon(
            imageVector = BlockerIcons.Error,
            contentDescription = stringResource(id = R.string.core_ui_error),
