...
import com.merxury.blocker.feature.appdetail.impl.componentdetail.ComponentDetailUiState.Error
...
fun ComponentDetailDialog(
    ...
    val viewModel: ComponentDetailViewModel = hiltViewModel<ComponentDetailViewModel, ComponentDetailViewModel.Factory>(
        key = componentName,
    ) { factory ->
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = if (uiState is Success) {
                    ...
                    stringResource(id = string.feature_appdetail_api_unknown)
                },
        ...
        confirmButton = {
            BlockerTextButton(
                ...
                Text(text = stringResource(string.feature_appdetail_api_save))
            }
        },
        dismissButton = {
            BlockerTextButton(
...
fun ComponentDetailPanel(
    ...
    Column(modifier = modifier) {
        ...
        OutlinedTextField(
            ...
            label = {
                Text(text = stringResource(id = string.feature_appdetail_api_blocking_effect))
            },
            onValueChange = {
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Text(text = stringResource(id = string.feature_appdetail_api_recommended_blocking))
        }
        Row(verticalAlignment = Alignment.CenterVertically) {
            Checkbox(
                ...
                onCheckedChange = {
                    onInfoChange.invoke(
                        componentDetailInfo.copy(
                            sdkName = if (it) {
                                string.feature_appdetail_api_unknown.toString()
                            } else {
                                null
                            },
                        ),
            ...
            Spacer(modifier = Modifier.width(8.dp))
            Text(text = stringResource(id = string.feature_appdetail_api_belonging_sdk))
        }
    }
}
