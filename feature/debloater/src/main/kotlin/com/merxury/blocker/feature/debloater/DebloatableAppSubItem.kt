                ...
                FlowRow(
                    ...
                    if (item.isLauncherEntry) {
                        AssistChip(
                            ...
                            label = {
                                Text(
                                    text = stringResource(R.string.feature_debloater_launcher_entry),
                    ...
                    if (item.isShareableComponent) {
                        AssistChip(
                            ...
                            label = {
                                Text(
                                    text = stringResource(R.string.feature_debloater_share_component),
                                    style = MaterialTheme.typography.labelSmall,
                                )
                            },
                            modifier = Modifier.padding(end = 4.dp),
                    ...
                    if (item.isDeeplinkEntry) {
                        AssistChip(
                            ...
                            label = {
                                Text(
                                    text = stringResource(R.string.feature_debloater_deeplink_entry),
                                    style = MaterialTheme.typography.labelSmall,
                                )
                            },
                            modifier = Modifier.padding(end = 4.dp),
