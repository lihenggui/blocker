...
fun ThemeSettings(
    ...
    Column(
        ...
        ItemHeader(
            title = stringResource(id = string.feature_settings_api_theme),
            extraIconPadding = true,
        )
        if (supportDynamicColor) {
            SwitchSettingItem(
                itemRes = string.feature_settings_api_dynamic_color,
                checked = settings.useDynamicColor,
                onCheckedChange = onChangeDynamicColorPreference,
            )
        }
        DialogSettingsItems(
            titleRes = string.feature_settings_api_dark_mode,
            selectedItem = settings.darkThemeConfig,
            itemList = listOf(
                FOLLOW_SYSTEM to string.feature_settings_api_system_default,
                LIGHT to string.feature_settings_api_light,
                DARK to string.feature_settings_api_dark,
            ),
