...
fun AppListSettings(
    ...
    Column(
        ...
        ItemHeader(
            title = stringResource(id = string.feature_settings_api_application_list),
            extraIconPadding = true,
        )
        SwitchSettingItem(
            itemRes = string.feature_settings_api_show_system_apps,
            checked = showSystemApps,
            onCheckedChange = onChangeShowSystemApps,
        )
        SwitchSettingItem(
            itemRes = string.feature_settings_api_show_service_info,
