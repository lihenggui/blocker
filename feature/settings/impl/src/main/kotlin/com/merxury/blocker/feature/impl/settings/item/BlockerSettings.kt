...
fun BlockerSettings(
    ...
    Column(modifier = modifier) {
        DialogSettingsItems(
            ...
            titleRes = string.feature_settings_api_controller_type,
            selectedItem = settings.controllerType,
            itemList = listOf(
                IFW to string.feature_settings_api_intent_firewall,
                PM to string.feature_settings_api_package_manager,
                SHIZUKU to string.feature_settings_api_shizuku,
                IFW_PLUS_PM to string.feature_settings_api_ifw_plus_pm,
            ),
            onValueChange = onChangeControllerType,
        )
        DialogSettingsItems(
            icon = ImageVectorIcon(BlockerIcons.Block),
            titleRes = string.feature_settings_api_online_rule_source,
            selectedItem = settings.ruleServerProvider,
            itemList = listOf(
                GITHUB to string.feature_settings_api_options_github,
                GITLAB to string.feature_settings_api_options_gitlab,
            ),
        ...
        DialogSettingsItems(
            ...
            titleRes = string.feature_settings_api_display_language,
            selectedItem = settings.appDisplayLanguage,
            itemList = listOf(
                "" to string.feature_settings_api_follow_system,
        ...
        DialogSettingsItems(
            ...
            titleRes = string.feature_settings_api_library_language,
