...
fun BlockerRulesSettings(
    ...
    Column(
        ...
        ItemHeader(
            title = stringResource(id = string.feature_settings_api_blocker_rules),
            extraIconPadding = true,
        )
        BlockerSettingItem(
            title = stringResource(id = string.feature_settings_api_export_rules),
            onItemClick = exportRules,
            extraIconPadding = true,
        )
        BlockerSettingItem(
            title = stringResource(id = string.feature_settings_api_import_rules),
...
fun IfwRulesSettings(
    ...
    Column(
        ...
        ItemHeader(
            title = stringResource(id = string.feature_settings_api_ifw_rules),
            extraIconPadding = true,
        )
        BlockerSettingItem(
            title = stringResource(id = string.feature_settings_api_export_ifw_rules),
            onItemClick = exportIfwRules,
            extraIconPadding = true,
        )
        BlockerSettingItem(
            title = stringResource(id = string.feature_settings_api_import_ifw_rules),
            onItemClick = importIfwRules,
            extraIconPadding = true,
        )
        BlockerSettingItem(
            title = stringResource(id = string.feature_settings_api_reset_ifw),
