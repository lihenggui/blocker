...
fun BackupSettings(
    ...
    Column(
        ...
        ItemHeader(
            title = stringResource(id = string.feature_settings_api_backup),
            extraIconPadding = true,
        )
        BlockerSettingItem(
            icon = ImageVectorIcon(BlockerIcons.Folder),
            title = stringResource(id = string.feature_settings_api_folder_to_save),
            summary = ruleBackupFolder.ifEmpty {
                stringResource(id = string.feature_settings_api_directory_invalid_or_not_set)
            },
            onItemClick = {
                try {
        ...
        SwitchSettingItem(
            itemRes = string.feature_settings_api_backup_system_apps,
            checked = backupSystemApps,
            onCheckedChange = onChangeBackupSystemApp,
        )
        SwitchSettingItem(
            itemRes = string.feature_settings_api_restore_system_apps,
