...
import com.merxury.blocker.feature.settings.api.R
...
private fun DialogSettingsItemPreview() {
    BlockerTheme {
        Surface {
            SettingDialog(
                titleRes = R.string.feature_settings_api_theme,
                items = listOf(
                    "Android" to R.string.feature_settings_api_android,
                    "Default" to R.string.feature_settings_api_theme_default,
                ),
                selectedValue = "Default" to R.string.feature_settings_api_theme_default,
                onValueChange = {},
            ) {}
        }
    }
