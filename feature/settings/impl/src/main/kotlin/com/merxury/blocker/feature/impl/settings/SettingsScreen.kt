...
import com.merxury.blocker.feature.impl.settings.item.AppListSettings
import com.merxury.blocker.feature.impl.settings.item.BackupSettings
...
fun SettingsScreen(
    ...
    Column(
        ...
        BlockerTopAppBar(
            title = stringResource(id = string.feature_settings_api_settings),
...
fun SettingsContent(
    ...
    Column(
        ...
        BlockerSettingItem(
            title = stringResource(id = string.feature_settings_api_import_mat_rules),
            onItemClick = {
                try {
        ...
        SwitchSettingItem(
            itemRes = string.feature_settings_api_anonymous_statistics,
            itemSummaryRes = string.feature_settings_api_anonymous_statistics_summary,
