...
private fun SwitchSettingsItemPreview() {
    BlockerTheme {
        Surface {
            SwitchSettingItem(
                itemRes = R.string.feature_settings_api_show_system_apps,
                checked = true,
            )
        }
    }
...
private fun SwitchSettingsItemLongNamePreview() {
    BlockerTheme {
        Surface {
            SwitchSettingItem(
                itemRes = R.string.feature_settings_api_file_manager_required,
                checked = true,
            )
        }
    }
...
private fun SwitchSettingsItemWithSummaryPreview() {
    BlockerTheme {
        Surface {
            SwitchSettingItem(
                itemRes = R.string.feature_settings_api_show_system_apps,
                itemSummaryRes = R.string.feature_settings_api_anonymous_statistics_summary,
