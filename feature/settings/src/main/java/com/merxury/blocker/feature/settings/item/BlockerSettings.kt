...
fun BlockerSettings(
    ...
    DialogSettingsItems(
        ...
        titleRes = string.feature_search_controller_type,
        selectedItem = settings.controllerType,
        itemList = listOf(
            IFW to string.feature_search_intent_firewall,
            PM to string.feature_search_package_manager,
            SHIZUKU to string.feature_search_shizuku,
        ),
        onValueChange = onChangeControllerType,
    )
    DialogSettingsItems(
        icon = ImageVectorIcon(BlockerIcons.Block),
        titleRes = string.feature_search_online_rule_source,
        selectedItem = settings.ruleServerProvider,
        itemList = listOf(
            GITHUB to string.feature_search_options_github,
            GITLAB to string.feature_search_options_gitlab,
        ),
