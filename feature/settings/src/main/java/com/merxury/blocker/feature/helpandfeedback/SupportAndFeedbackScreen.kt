...
fun SupportAndFeedbackRoute(
    ...
    Scaffold(
        topBar = {
            BlockerTopAppBar(
                title = stringResource(id = string.feature_search_support_and_feedback),
...
fun SupportAndFeedbackScreen(
    ...
    Column {
        BlockerSettingItem(
            ...
            title = stringResource(id = string.feature_search_project_homepage),
            onItemClick = { onProjectHomeClick() },
        )
        BlockerSettingItem(
            icon = ImageVectorIcon(BlockerIcons.Rule),
            title = stringResource(id = string.feature_search_rule_repository),
            onItemClick = { onRulesRepositoryClick() },
        )
        BlockerSettingItem(
            icon = ImageVectorIcon(BlockerIcons.BugReport),
            title = stringResource(id = string.feature_search_report_bugs_or_submit_ideas),
            onItemClick = { onReportBugClick() },
        )
        BlockerSettingItem(
            icon = DrawableResourceIcon(BlockerIcons.Telegram),
            title = stringResource(id = string.feature_search_telegram_group),
            onItemClick = { onTelegramGroupLinkClick() },
        )
        BlockerSettingItem(
            icon = ImageVectorIcon(BlockerIcons.DesignService),
            title = stringResource(id = string.feature_search_designers_homepage),
            onItemClick = { onDesignLinkClick() },
        )
        BlockerSettingItem(
            icon = ImageVectorIcon(BlockerIcons.DocumentScanner),
            title = stringResource(id = string.feature_search_open_source_licenses),
